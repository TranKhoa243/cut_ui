...
import 'package:flutter_base_structure/presentation/utils/page_tag.dart';
...
class ReloadDataEvent extends BaseEvent {
  bool? isLoadNotificationBadge;
  bool? isReloadWallet;
  ReloadDataEvent({this.isLoadNotificationBadge, this.isReloadWallet});
}

class ReloadLinkedCardEvent extends BaseEvent {}

class RequestLoadMoreEvent extends BaseEvent {}
class ReloadTransactionEvent extends BaseEvent {}
...
class ReloadUserDataEvent extends BaseEvent {}

class GetTransactionLimitTotalEvent extends BaseEvent {}


class GoToTransactionNeedConfirmEvent extends BaseEvent {}
